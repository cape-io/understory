(function() {
  ...
  describe('understory', function() {
    ...
    return describe('#romanize', function() {
      return it('Capitalizes words that contain only roman numerals.', function() {
        return understory.romanize('is Iv mx').should.eql('is IV MX');
      });
    });
  });
